...
# =====================================================
# FILTER TO LIPID MASS RANGE ONLY
# =====================================================

mz_values = adata_d0.var_names.astype(float)
...
adata_d0 = adata_d0[:, lipid_mask].copy()
adata_d5 = adata_d5[:, lipid_mask].copy()
...
output_dir = OUTPUTS / "spateo_ot" / dataset_id
